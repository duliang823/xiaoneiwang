...
<!-- 这里考虑的是大学生的特别的情况: start-->
    			...
    			<tr class="gra_spe">
	    			...
	    			<td>
	    				<!-- 隐藏一个大学的id，注册一个用户，应当以大学的编号为准,而不能以大学的名称为准 -->
...
<!-- 准备显示的大学表格 end -->
  ...
  <script type="text/javascript" src="/xiaoneinew/js/jquery-1.11.1.min.js"></script>
